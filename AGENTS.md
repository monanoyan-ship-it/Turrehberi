# Erkan Tatil Plani - Codex Kurallari

## ZORUNLU: ClaudeManager Entegrasyonu

Bu projenin TUM kurallari, tercihleri ve hata gecmisi **ClaudeManager**'da tutulur. AGENTS.md her okunduğunda ClaudeManager patterns'lari da okunmalidir.
