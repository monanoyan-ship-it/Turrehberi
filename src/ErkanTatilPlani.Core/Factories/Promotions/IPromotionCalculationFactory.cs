...
{
    Task<PriceCalculationResult> CalculatePriceAsync(int tourId, int numberOfPeople, DateTime? tourStartDate = null, string? couponCode = null, int? visitorId = null, int? scheduleId = null);
