...
namespace ErkanTatilPlani.Data.Migrations
{
    ...
    [Migration("20260223212025_AddTourSchedule")]
    partial class AddTourSchedule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErkanTatilPlani.Core.Entities.TourDate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ErkanTatilPlani.Core.Entities.Reservation", b =>
                {
                    ...
                    b.HasOne("ErkanTatilPlani.Core.Entities.TourDate", "TourDate")
                        .WithMany()
            ...
            modelBuilder.Entity("ErkanTatilPlani.Core.Entities.TourSchedule", b =>
                {
                    b.Navigation("MaterializedDates");
                });
