...
namespace ErkanTatilPlani.Data.Migrations
{
    ...
    [Migration("20260513071936_AddPaymentMethodSettingsAndPaymentMethodSelection")]
    partial class AddPaymentMethodSettingsAndPaymentMethodSelection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErkanTatilPlani.Core.Entities.Faq", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ErkanTatilPlani.Core.Entities.PaymentMethodSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("SupportsMarketplaceSplit")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("IsActive", "IsEnabled", "IsDefault");

                    b.ToTable("PaymentMethodSettings");
                });
            ...
            modelBuilder.Entity("ErkanTatilPlani.Core.Entities.Reservation", b =>
                {
                    ...
                    b.Property<string>("PaymentProviderSystemName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NumberOfPeople = 2,
                            PaidAmount = 0m,
                            PaymentMethodSystemName = "iyzico-card",
                            PaymentProviderSystemName = "iyzico",
                            PaymentStatus = 0,
            ...
            modelBuilder.Entity("ErkanTatilPlani.Core.Entities.SupportTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ErkanTatilPlani.Core.Entities.Tour", b =>
                {
                    ...
                    b.Property<string>("SustainabilityInfo")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ErkanTatilPlani.Core.Entities.TourDigitalContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ErkanTatilPlani.Core.Entities.TourPackage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ErkanTatilPlani.Core.Entities.TourPackageItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ErkanTatilPlani.Core.Entities.TourPackageItem", b =>
                {
                    ...
                    b.HasOne("ErkanTatilPlani.Core.Entities.TourPackage", "TourPackage")
                        .WithMany("Items")
